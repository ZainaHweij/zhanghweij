...
const tiers = [
  {
    name: "Essentials",
    price: "$1,500",
    description: "Perfect for students who need targeted help on key application components.",
    features: [
  ...
  },
  {
    name: "Comprehensive",
    price: "$3,500",
    description: "Our most popular package — full-cycle support from strategy through submission.",
    features: [
  ...
  },
  {
    name: "Premium",
    price: "$6,000",
    description: "White-glove service for students applying to the most competitive programs.",
    features: [
      ...
      <section className="pt-28 pb-20 bg-background">
        <div className="container mx-auto px-4">
          <div className="text-center max-w-xl mx-auto mb-14">
            <p className="text-gold font-medium text-sm uppercase tracking-widest mb-2">Pricing</p>
            <h1 className="text-3xl md:text-5xl font-bold text-foreground mb-4">
              Invest in Your Future
            </h1>
            <p className="text-muted-foreground leading-relaxed">
              Choose the level of support that matches your goals. Every package includes personalized, one-on-one guidance.
            </p>
          </div>
          ...
          <div className="text-center mt-16 max-w-lg mx-auto">
            <p className="text-muted-foreground text-sm">
              ...
              <a href="mailto:info@zhanghweij.com" className="text-primary font-medium hover:underline">
